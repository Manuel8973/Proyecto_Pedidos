...
{
    [Authorize(Policy = "AdminOrEmpleado")] // Admins y empleados pueden gestionar clientes
    public class ClienteController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Email,Direccion")] ClienteModel clienteModel)
        {
            if (ModelState.IsValid)
            {
                ...
                TempData["SuccessMessage"] = $"Cliente '{clienteModel.Nombre}' creado exitosamente.";
        ...
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Email,Direccion")] ClienteModel clienteModel)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    await _context.SaveChangesAsync();
                    TempData["SuccessMessage"] = $"Cliente '{clienteModel.Nombre}' actualizado exitosamente.";
                }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (clienteModel != null)
            {
                ...
                TempData["SuccessMessage"] = $"Cliente '{clienteModel.Nombre}' eliminado exitosamente.";
            }
